...
dengue_original <- fread(file = "C:\\Users\\user\\Desktop\\SprintDengue2025\\dengue.csv")
climate = fread(file = "C:\\Users\\user\\Desktop\\SprintDengue2025\\climate.csv")
...
dengue_estado <- dengue_completo %>%
  ...
  summarise(
    ...
    train_2 = all(train_2 == TRUE),
    target_2 = all(target_2 == TRUE),
    .groups = "drop"
  )
...
save.image(file = "C:\\Users\\user\\Desktop\\SprintDengue2025\\Resultados_SprintDengue_treino2.RData")
