...
ggsave(filename = "resultados/Resultados_SprintDengue_treino1.png", plot = combined_plot, width = 14, height = 8, units = "in")

save.image(file = "resultados/Resultados_SprintDengue_treino1.RData")
